    ...
    <Box
      ...
      sx={{
        ...
        "&::before": {
          ...
          filter: isViewed ? "none" : "drop-shadow(0 0 8px rgba(102, 126, 234, 0.6))",
          animation: isViewed ? "none" : "pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite"
        }
      }}
    >
      <Box
      ...
      >
        ...
        <Avatar
          ...
          sx={{
            ...
            boxShadow: isViewed 
              ...
              : "0 0 12px rgba(102, 126, 234, 0.8), 0 0 24px rgba(118, 75, 162, 0.4)",
            transition: "all 0.3s"
          }}
        >
        ...
        <Box
          sx={{
            ...
            background: isViewed
              ...
              : "linear-gradient(to top, rgba(102, 126, 234, 0.5), transparent)",
        ...
        {isViewed && (
          ...
          >
            <Typography sx={{ color: "#fff", fontSize: "0.75rem" }}>✓</Typography>
          </Box>
        )}
      </Box>
    </Box>
